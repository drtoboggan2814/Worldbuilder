...
tuple<float, char, float> tideLockedWorldEffects(const bool& tidalLockedOrNot, float surfaceTemperature, const char& atmosphericPressureCategory, float atmosphericPressure, float atmosphereMass, float surfaceGravity, const char& worldType, float hydrographicCoverage)
{
...
tuple<bool, float> resonantWorldEffects(float orbitalEccentricity, const bool& tidalLockedOrNot, float orbitalPeriod, float apparentDayLength)
{
//	Initialize return value
